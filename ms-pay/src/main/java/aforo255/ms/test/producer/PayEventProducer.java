package aforo255.ms.test.producer;
...
public class PayEventProducer {
	...
	public ListenableFuture<SendResult<Integer, String>> sendPayEvent(PayInvoice invoiceEvent)
			throws JsonProcessingException {
		Integer key = invoiceEvent.getIdOperation();
